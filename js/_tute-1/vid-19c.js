...
// Let's destructure the `todos` and `visibilityFilter` from the props
// Let's make the active filter a different color
// Pass the current filter to each FilterLink
// And we'll use that to implement a SPAN (so it's not clickable), and a different COLOR
